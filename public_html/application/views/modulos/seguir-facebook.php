...
<div class="insta-bloco-facebook">
	<div class="container">
		...
		<div class="team-body" id="itens-instagram-facebook"></div>
	</div>
</div>
...
<script type="text/javascript">
    ...
    //jQuery(document).ready(function(){
        jQuery.ajax({
            type: 'POST',
            url:"/posts-facebook?limit="+limit_instagram,
            data: {
            ...
            success: function (response) {
                if(response){
                    response.forEach(function(item, index){
                        var img = '/arquivos/imagens/facebook/'+item.img;
                        //var img = item.img;
                        var link= item.link;
                        var title = item.title;
                        
                        jQuery('#itens-instagram-facebook').append('<a class="item-insta carregar-img" href="'+link+'" target="_blank" title="'+title+'"><img src="'+img+'" title="'+title+'" alt="'+title+'"></a>');
