...
if(!$config['telefone1']) return;
?>

<a id="popup117_imgn_cmnc_popup2" href="https://api.whatsapp.com/send?1=pt_BR&phone=55<?=preg_replace('/[^0-9]/', '', $config['telefone1']);?>&text=Olá, Vim do site e gostaria de mais informações" target="_blank" title="whatsapp" style="width: 60px; height: 60px; padding: 0px; position: fixed; right:30px; bottom: 30px; box-sizing: border-box; border-radius: 50%; font-size: 14px; z-index:9999;">
