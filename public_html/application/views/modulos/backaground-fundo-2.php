...
$info = $controller->model_banner->getSlidesUnicaImg($id_banner,29);
...
<div class="<?php echo $cls; ?>">
	<div class="slides diagonal-left-2">
        ...
        endforeach; ?>
            ...
            <div class="container blocos-informacoes-slide modelo-texto-<?php echo $slide["tipo_texto"]?>">
                <div class="bloco">
                    ...
                    <h3 class="tituloPadrao textCenter"><?php echo $slide["descricao"];?></h3>
...
.<?php echo $cls; ?> .slides.diagonal-left-2 span{
    position: relative;
    padding: calc(60px + var(--tamanho-reta)) 0 calc(60px + var(--tamanho-reta)) 0;
    margin: 0;
    clip-path: polygon(0 var(--tamanho-reta), 100% 0, 100% calc(100% - var(--tamanho-reta)), 0 100%);
}
