        ...
        <div class="container">
            <div class="blocotextoTopo">
                ...
                <div class="botoesTopo">
                    ...
                    <a href="/admin/institucional/profissional.html" class="botao_padra_1 btn_verde">Adicionar</a>
                </div>
            </div>
        </div>
    </div>
	<div class="meio-componente">
        <div class="container">
            <div class="blocoConteudo">
                ...
                <form class="blocoTabela" action="/admin/Admin_controller_institucional/profissionais_excluir" name="formTabela" method="post">
                            ...
                            <tbody>
                                <?php foreach($dados["resultado"] as $item):?>
                                    <tr>
                                        ...
                                        <td><a href="/admin/institucional/profissional/<?php echo $item->id;?>.html" title="<?php echo $item->nome;?>" ><?php echo $item->nome;?></a></td>
