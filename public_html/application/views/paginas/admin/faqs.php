    ...
    <div class="topo-componente">
        <div class="container">
            <div class="blocotextoTopo">
                <div class="tituloTopo">FAQs</div>
                <div class="botoesTopo">
                    <span class="botao_padra_1 btn_vermelho" onclick="excluir();">Excluir</span>
                    <a href="/admin/faq.html" class="botao_padra_1 btn_verde">Adicionar</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="blocoConteudo">
                ...
                <div class="filtroConteudo">
                    ...
                    <form method="POST" action="" name="form_filtro"  class="filtroUmaLinha">
                        <input class="campo_padrao" type="text" name="pergunta" placeholder="Pergunta" style="width: 300px;" value="<?php echo (isset($args["pergunta"])?$args["pergunta"]:''); ?>">
                ...
                <form class="blocoTabela" action="/admin/Admin_controller_faq/faq_excluir" name="formTabela" method="post">
                            ...
                            <tbody>
                                <?php foreach($dados["resultado"] as $item):?>
                                    <tr>
                                        ...
                                        <td><a href="/admin/faq/<?php echo $item->id;?>.html" title="<?php echo $item->pergunta;?>" ><?php echo $item->pergunta;?></a></td>
