    ...
    <div class="topo-componente">
        <div class="container">
            <div class="blocotextoTopo">
                <div class="tituloTopo">Blog</div>
                <div class="botoesTopo">
                    <span class="botao_padra_1 btn_vermelho" onclick="excluir();">Excluir</span>
                    <a href="/admin/blog-artigo.html" class="botao_padra_1 btn_verde">Adicionar</a>
                </div>
            </div>
        </div>
    </div>
	<div class="meio-componente">
        <div class="container">
            <div class="blocoConteudo">
                ...
                <form class="blocoTabela" name="formTabela" method="post" action="/admin/Admin_controller_blog/excluir_artigo">
                            ...
                            <tbody>
                                <?php foreach($dados["resultado"] as $item):?>
                                    <tr>
                                        ...
                                        <td><a href="/admin/blog-artigo/<?php echo $item->id;?>.html" title="<?php echo $item->titulo;?>" ><?php echo $item->titulo;?></a></td>
