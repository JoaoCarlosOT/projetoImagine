        ...
        <div class="container">
            <div class="blocotextoTopo">
                ...
                <div class="botoesTopo">
                    <a href="/admin/institucional/categorias.html" class="botao_padra_1 btn_cinza">Voltar</a>
                    ...
                    <div class="informacao" id="bloco1">
                        ...
                        <div class="linhaCompleta formulario-pd">
                                ...
                                <div class="linha" style="width: 20%;">
                                    <div class="txtCampo">Exibir no menu?</div>
                                    <div class="input-div">
                                        <select name="exibir_menu" class="campo-padrao">
                                            <option value="0" <?php echo (isset($dados["exibir_menu"]) && $dados["exibir_menu"] == 0 ?'selected=""':'');?>>Não</option>
                                            <option value="1" <?php echo (isset($dados["exibir_menu"]) && $dados["exibir_menu"] == 1 ?'selected=""':'');?>>Sim</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="linha" style="width: 10%;">
                                    ...
                                    <div class="input-div">
                                        <input class="campo-padrao" type="text" name="ordem" value="<?php echo (isset($dados["ordem"])?$dados["ordem"]:0);?>" >
                                    </div>
                                </div>
                        </div>
