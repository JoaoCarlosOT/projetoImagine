    ...
    <div class="topo-componente">
        <div class="container">
            <div class="blocotextoTopo">
                <div class="tituloTopo">Big numbers</div>
                <div class="botoesTopo">
                    <span class="botao_padra_1 btn_vermelho" onclick="excluir();">Excluir</span>
                    <a href="/admin/institucional/bignumber.html" class="botao_padra_1 btn_verde">Adicionar</a>
                </div>
            </div>
        </div>
    </div>
	<div class="meio-componente">
        <div class="container">
            <div class="blocoConteudo">
                ...
                <form class="blocoTabela" action="/admin/Admin_controller_institucional/bignumber_excluir" name="formTabela" method="post">
                            ...
                            <tbody>
                                <?php foreach($dados["resultado"] as $item):?>
                                    <tr>
                                        ...
                                        <td><a href="/admin/institucional/bignumber/<?php echo $item->id;?>.html" title="<?php echo $item->nome;?>" ><?php echo $item->nome;?></a></td>
