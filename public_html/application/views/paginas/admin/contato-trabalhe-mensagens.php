    ...
    <div class="topo-componente">
        <div class="container">
            <div class="blocotextoTopo">
                <div class="tituloTopo">CRM - Trabalhe Conosco registradas</div>
                <div class="botoesTopo">
                    <a href="/admin/contato/vagas.html" class="botao_padra_1 btn_cinza">Nossas Vagas</a>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <tbody>
                                <?php foreach($dados["resultado"] as $item):?>
                                    <tr>
                                        ...
                                        <td><a href="/admin/contato/trabalhe-mensagem/<?php echo $item->id;?>.html" title="<?php echo $item->nome;?>" ><?php echo ($item->nome?$item->nome:'Sem nome');?></a></td>
                                        ...
                                        <?php if($item->telefone1):?>
                                            <td><?php echo $item->telefone1;?></td>
                                        <?php else:?>
                                            <td>Não Informado</td>
                                        <?php endif;?>
                                        <?php if($item->telefone2):?>
                                            <td><?php echo $item->telefone2;?></td>
                                        <?php else:?>
                                            <td>Não Informado</td>
                                        <?php endif;?>
