        ...
        <div class="container">
            <div class="blocotextoTopo">
                ...
                <div class="botoesTopo">
                    ...
                    <a href="/admin/copywriter.html" class="botao_padra_1 btn_verde">Adicionar</a>
                </div>
            </div>
        </div>
    </div>
	<div class="meio-componente">
        <div class="container">
            <div class="blocoConteudo">
                ...
                <form class="blocoTabela" action="/admin/Admin_controller_copywriter/copywriter_excluir" name="formTabela" method="post">
                            ...
                            <tbody>
                                <?php foreach($dados["resultado"] as $item):?>
                                    <tr>
                                        ...
                                        <td><a href="/admin/copywriter/<?php echo $item->id;?>.html" title="<?php echo $item->titulo;?>" ><?php echo $item->titulo;?></a></td>
