    ...
    <div class="topo-componente">
        <div class="container">
            <div class="blocotextoTopo">
                <div class="tituloTopo">Clientes</div>
                <div class="botoesTopo">
                    <span class="botao_padra_1 btn_vermelho" onclick="excluir();">Excluir</span>
                    <a href="/admin/cliente.html" class="botao_padra_1 btn_verde">Adicionar</a>
                </div>
            </div>
        </div>
    </div>
	<div class="meio-componente">
        <div class="container">
            <div class="blocoConteudo">
                ...
                <form class="blocoTabela" action="/admin/Admin_controller_cliente/cliente_excluir" name="formTabela" method="post">
                        ...
                        <table class="tabela_padrao" >
                            <thead>
                                <tr>
                                    ...
                                    <td style="width: 150px;">Último login</td>
                            ...
                            <tbody>
                                <?php foreach($dados["resultado"] as $item):?>
                                    <tr>
                                        ...
                                        <td><a href="/admin/cliente/<?php echo $item->id;?>.html" title="<?php echo $item->nome;?>" ><?php echo $item->nome;?></a></td>
                                        ...
                                        <td><?php echo ($item->ultimo_login?date('d/m/Y \à\s H:i',strtotime($item->ultimo_login)):'Não acessou');?></td>
                                        <td><?php echo date('d/m/Y \à\s H:i',strtotime($item->cadastrado));?></td>
                                    </tr>
                                <?php endforeach;?>
                            </tbody>
                        </table>
