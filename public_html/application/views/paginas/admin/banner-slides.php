    ...
    <div class="topo-componente">
        <div class="container">
            <div class="blocotextoTopo">
                <div class="tituloTopo">Banner Nº: <?=$this->dados["dados"]['id_banner']?> - Slides</div>
                <div class="botoesTopo">
                    ...
                    <a href="/admin/banner/<?=$this->dados["dados"]['id_banner']?>/slide.html" class="botao_padra_1 btn_verde">Adicionar</a>
                </div>
            </div>
        </div>
    </div>
	<div class="meio-componente">
        <div class="container">
            <div class="blocoConteudo">
                ...
                <form class="blocoTabela" action="/admin/Admin_controller_banner/slides_excluir" name="formTabela" method="post">
                        ...
                        <table class="tabela_padrao" >
                            <thead>
                                <tr>
                                    ...
                                    <td>Nome</td>
                                    <td style="width: 200px;">Tipo de banner</td>
                                    <td style="width: 100px;">Ordem</td>
                            ...
                            <tbody>
                                <?php foreach($dados["resultado"] as $item):?>
                                    <tr>
                                        ...
                                        <td><a href="/admin/banner/<?=$this->dados["dados"]['id_banner']?>/slide/<?php echo $item->id;?>.html" title="<?php echo $item->nome;?>" ><?php echo $item->nome;?></a></td>
                                        
                                        <?php if($item->tipo_banner == 0):?>
                                            <td class="text-center">Imagem Full</td>
                                        <?php elseif($item->tipo_banner == 1):?>
                                            <td class="text-center">Banner com CTA</td>
                                        <?php elseif($item->tipo_banner == 2):?>
                                            <td class="text-center">Vídeo Full</td>
                                        <?php else:?>
                                            <td class="text-center"></td>
                                        <?php endif;?>

                                        <td class="text-center"><?php echo $item->ordem;?></td>
                    ...
                    <?php endif;?>
                    <input type="hidden" name="id_banner" value="<?=$this->dados["dados"]['id_banner']?>" >
                </form>
                </div>
            </div>
