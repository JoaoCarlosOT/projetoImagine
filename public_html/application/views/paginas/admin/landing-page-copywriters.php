    ...
    <div class="topo-componente">
        <div class="container">
            <div class="blocotextoTopo">
                <div class="tituloTopo">Copywriters</div>
                <div class="botoesTopo">
                    <a href="/admin/landing-page/copywriter-configuracao.html" class="botao_padra_1 btn_cinza">Configuração</a>
                    <span class="botao_padra_1 btn_vermelho" onclick="excluir();">Excluir</span>
                    <a href="/admin/landing-page/copywriter.html" class="botao_padra_1 btn_verde">Adicionar</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="blocoConteudo">
                ...
                <div class="filtroConteudo">
                    ...
                    <form method="POST" action="" name="form_filtro"  class="filtroUmaLinha">
                        <input class="campo_padrao" type="text" name="titulo" placeholder="Título" style="width: 300px;" value="<?php echo (isset($args["titulo"])?$args["titulo"]:''); ?>">
                ...
                <form class="blocoTabela" action="/admin/Admin_controller_landingpage/copywriter_excluir" name="formTabela" method="post">
                            ...
                            <tbody>
                                <?php foreach($dados["resultado"] as $item):?>
                                    <tr>
                                        ...
                                        <td><a href="/admin/landing-page/copywriter/<?php echo $item->id;?>.html" title="<?php echo $item->titulo;?>" ><?php echo $item->titulo;?></a></td>
