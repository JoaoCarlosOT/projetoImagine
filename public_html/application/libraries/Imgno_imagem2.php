...
class Imgno_imagem2 {
	...
	public function enviar_imagens($atual, $campo, $dir, $larg = 0, $alt = 0, $larg_mini = 0, $alt_mini = 0, $metodo = 0, $transparente = 0, $tamanho_fixo = 0, &$nomes = array(), $imagens_antigas = array(), $multi = FALSE){
		...
		foreach($nomes as $k => $nome) {
			...
			$nomes[$k] = self::_parseName($nome, $dir, $mini_dir);
		}
		if(!$img_erro) {
