...
// echo $_SERVER['DOCUMENT_ROOT'] . DIRECTORY_SEPARATOR . 'CI.php';exit;
// $CI = require $_SERVER['DOCUMENT_ROOT'] . DIRECTORY_SEPARATOR . 'CI.php';
// $CI = & get_instance();
// require_once(APPPATH .'base/Imgno__model.php');
// $model = new Imgno__model();
// $pasta_user = $model->buscar_pasta_usuario();
$pasta_user = 'pasta_geral';

if(!$pasta_user) die('Access Denied!');
...
$config = array(
	...
	*/
	...
	|
	*/
	'upload_dir' => '/arquivos/javascript/responsive_filemanager/source/'.$pasta_user.'/',
	/*
	|--------------------------------------------------------------------------
	...
	|
	*/
	'current_path' => '../source/'.$pasta_user.'/',
	...
	|
	*/
	'thumbs_base_path' => '../thumbs/'.$pasta_user.'/',
